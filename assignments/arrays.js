...
console.log(`Car 33 is a ${Object.entries(inventory[32])[3]} ${Object.entries(inventory[32])[1]} ${Object.entries(inventory[32])[2]}`);

// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.
let lastCar = 0;
lastCar = inventory[inventory.length - 1]
console.log(`${Object.entries(lastCar)[1]} ${Object.entries(lastCar)[2]}`);

// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical order and log the results in the console
let carModels = []; // loop through and get car models
let carModelsSorted = []; // alphabetical order 
console.log();
var i
/*for(i=0; i < inventory.length; i++){
  carModels = Object.values(inventory[i])[2];
  console.log(carModels);
  carModelsSorted = carModels.slice(); // convert to an array
  console.log(carModelsSorted);
}*/
for(i=0; i < inventory.length; i++){
  var car= Object.values(inventory[i])[2];
  carModels.push(car);}
  //console.log(carModels)
...
/*for (i=0; i < inventory.length; i++){
  carYears = Object.values(inventory[i])[3];
  console.log(carYears);
  carYearsSorted = carYears.slice();
  console.log(carYearsSorted);
}*/

for (i=0; i < inventory.length; i++){
  var year = Object.values(inventory[i])[3];
  carYears.push(year);
}
console.log(carYears);
...
/*for (i=0; i < inventory.length; i++){
  var m = Object.values(inventory[i])[3];
  if (m < 2000){
    oldCars.push(m);}
...
for (i=0; i < inventory.length; i++){
  var car = Object.values(inventory[i])[1];
  All_Make.push(car);
  console.log(All_Make);
  BMWAndAudi = All_Make.filter(car => (car ==='BMW' || car === 'Audi'));
